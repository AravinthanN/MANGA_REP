...
the back of a car asked.`,
  ...
  `......`,
  `“Mm... devil’s son,the one who defied death, huh,” the man smirked MENACINGLY, as if he was about to do what he had ordered his men to do in the farm(CUT THE BOY AND CHO).`,
  `**The look on him was so powerful that it sent us back in time.**`,
  `CUT TO PAST (Years Ago)`,
  `A palace`,
  `A Home like a palace, a home with a fountain at its center. Birds roamed freely inside, and a single tree near the fountain teemed with chirping birds. `,
  `It was filled with the soothing sounds of nature.`,
  `Inside that home, in a room, a man, who is a scientist, prayed hard while hearing the sound of his wife crying.`,
  `He couldnt hear her crying`,
  `The scientist was expecting his FIRST? baby (The Boy, Cho's brother)`,
  `Don't worry, sir, for your good heart, this baby will be....,' said a palace worker woman `,
  `"please dont!! ..... go help them",he pleaded `,
  `Meanwhile Palace workers chatted excitedly about the baby’s birth.`,
  ...
  `The BEAST stood behind him,it was right of him but he didnt felt its presence and now only he felt it was close. He got ready to fight it. Suddenly, he turned around and was shocked to see it looked like the creature he had described—"an elephant with two legs and a creepy smile."`,
  `He watched as it reached for him,he couldn't move as he is in fear,confused as he dont know what is happening. In its claws, it held a woman half eaten and asking for help, in its mouth, there was blood, ****that  woman was That Red Saree.****`,
  ...
  `POST  CREDITS:`,
  `FUTURE  `,
  `The city both The boy and cho wanted to go was broken and crowded, filled with laughter that seemed crazy compared to the sad reality underneath. On stage, a teen boy(THE  BOY ,cho's brother) knelt with his wrists in chains. His face was hurt and covered in blood.`,
