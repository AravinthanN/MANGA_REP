const texts = [
  ...
  `He felt really hurt as he is the reason for  those kids not playing with his sister`,
...
the back of a car asked.`,
  ...
  `......`,
  `“Mm... devil’s son, huh,” the man smirked MENACINGLY, as if he was about to do what he had ordered his men to do in the farm.`,
  `**The look on him was so powerful that it sent us back in time.**`,
  `CUT TO PAST (Years Ago)`,
  `A palace`,
  `A palace like a home, a home with a fountain at its center. Birds roamed freely inside, and a single tree near the fountain teemed with chirping birds. `,
  ...
  `"please go.... help them",he pleaded `,
  ...
  `worker 3 who was cracking so called jokes , froze there like she saw a BEAST`,
