const texts = [
  ...
  `“Must be that red-assed shithead,” the bee muttered, looking down with its hand on its chin`,
  `Meanwhile, Cho tried to capture the bee`,
  `The bee dodged her`,
  `“Hey… so you chose hands, huh?”`,
  `“Alright-iieeezzz, bbzzzz, as you wish,” the bee said`,
  ...
  `“Tiger strategy, huh?” the bee smirked`,
  ...
  `The bee dodged`,
  `The bee spun, did some unnecessary stunts, and finally pinched her nose`,
  ...
  `“Big bro!” she cried`,
  `Meanwhile, the bee and her brother were talking`,
  ...
  `“Raaahhhh!”“Help!” Cho called as she fell right in front of the kids`,
