(() => {
  ...
  ((e.id = 974),
    ...
    (e.modules = {
              ...
              children: [
                ...
                {},
                {
                  page: [
                    ...
                    'C:\\Users\\Aravinthan\\manga\\MANGA_REP\\apps\\web\\app\\page.tsx',
                  ],
                },
              ],
            },
      ...
      5526: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 6345));
      },
      6206: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 27));
      },
      1975: (e, t) => {
        'use strict';
        function r() {
      ...
      27: (e, t, r) => {
        ...
        var s = r(1975),
          o = r.n(s),
          i = r(3449);
        let a = () => [{ title: 'Chapter 1', path: 'chapter-1' }],
          l = () => {
            let e = (0, i.useRouter)(),
              t = (t) => {
                e.push(`/chapters/${t}`);
            ...
            return (0, n.jsxs)(n.Fragment, {
              children: [
                (0, n.jsxs)(o(), {
                  children: [
                    (0, n.jsx)('title', { children: 'The Book Realm' }),
                    (0, n.jsx)('meta', {
                      name: 'description',
                      content: 'Step into the world of stories',
                    }),
                  ],
                }),
                (0, n.jsx)('main', {
                  className:
                    'min-h-screen bg-gradient-to-b from-black via-red-900 to-black text-white flex items-center justify-center',
                  children: (0, n.jsxs)('div', {
                    className: 'text-center px-6',
                    children: [
                      (0, n.jsx)('h1', {
                        className:
                          'text-5xl md:text-7xl font-bold mb-6 tracking-wide',
                        children: 'ஓ',
                      }),
                      (0, n.jsx)('p', {
                        className:
                          'text-xl md:text-2xl mb-10 italic text-red-200',
                        children: '“A beacon among the darkness.”',
                      }),
                      (0, n.jsxs)('div', {
                        className:
                          'border-4 border-red-600 p-8 rounded-lg bg-black/60 shadow-2xl',
                        children: [
                          (0, n.jsx)('h2', {
                          ...
                          (0, n.jsx)('ul', {
                            className: 'space-y-2 text-left text-red-300',
                            children: a().map((e, r) =>
                              (0, n.jsx)(
                                'li',
                                {
      ...
      6345: (e, t, r) => {
        'use strict';
        r.d(t, { default: () => n });
        let n = (0, r(4520).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Aravinthan\\\\manga\\\\MANGA_REP\\\\packages\\\\ui\\\\block\\\\layout\\\\home\\\\home.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
