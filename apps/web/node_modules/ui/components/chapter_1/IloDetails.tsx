  ...
  return (
    <>
      <button
        ...
        className="mx-auto px-8 py-3 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 
             ...
             focus:outline-none focus:ring-4 focus:ring-pink-300 mb-2"
      >
        Open Ilo Preview
      </button>
